...
<div id="buddypress">
	<div class="container">
		<div class="row">
					...
					<div class="item-list-tabs" id="subnav" role="navigation">
						<ul>
							...
							<li id="members-order-select" class="last filter">
								<label for="members-order-by"><?php _e( 'Show', 'buddypress' ); ?></label>
			...
			<?php 
			if ( is_active_sidebar( 'buddpress_sidebar' ) ) { ?>
				<div id="sidebar" class="col-md-3 buddy-sidebar">
				    <aside class="widget-area">
				        <?php dynamic_sidebar('buddpress_sidebar'); ?>
				    </aside>
				</div> <!-- #sidebar -->
			<?php }?>
		</div><!-- /.row -->
