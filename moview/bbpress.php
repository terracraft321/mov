...
<section id="main">
   <?php
        $output = '';
        if( moview_options_url('bbpress-forums-banner','url') ){
            $output = 'style="background-image:url('.esc_url( moview_options_url('bbpress-forums-banner','url') ).');background-size: cover;background-position: 50% 50%;padding: 65px 0;"';
        }else{
   ...
   <div class="sub-title" <?php echo $output;?>>
    ...
    <div class="container">
        ...
        if ( is_active_sidebar( 'bbpress_sidebar' ) ) { ?>
            <div id="sidebar" class="col-md-3 bbpress-sidebar">
